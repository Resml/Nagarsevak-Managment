...
const TenantContext = createContext<TenantContextType>({ tenant: null, loading: true, tenantId: null, refreshTenant: async () => {} });
...
export const TenantProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <TenantContext.Provider value={{ tenant, loading, tenantId: tenant?.id || null, refreshTenant: fetchTenant }}>
            {loading ? (
