...
import WhatsAppTutorial from '../../components/tutorial/WhatsAppTutorial';
    ...
    return (
        <div className="space-y-6 flex flex-col h-full">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 flex-none">
                <div className="tutorial-wa-header">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <button
                        ...
                        className="ns-btn ns-btn-secondary tutorial-wa-help border border-brand-200 text-brand-700 bg-white hover:bg-brand-50"
                    >
                        <HelpCircle className="w-4 h-4 mr-2" />
                        {language === 'mr' ? 'मदत' : 'Help'}
                    </button>
                    <div className={`px-3 py-1 rounded-full text-xs font-bold border flex items-center gap-1.5 tutorial-wa-status ${botStatus === 'connected' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200'}`}>
            ...
            <div className="flex space-x-1 bg-white p-1 rounded-xl border border-gray-200 flex-none w-fit tutorial-wa-tabs">
            ...
            {activeTab === 'send' ? (
                <>
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3 flex-none tutorial-wa-filters">
                    ...
                    <div className="flex-1 flex flex-col lg:flex-row gap-6 overflow-hidden tutorial-wa-list">
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col gap-4 tutorial-wa-compose">
                            <div className="ns-card p-4 flex flex-col h-full bg-brand-50/30 border-brand-100">
                                ...
                                <button onClick={handleSendWhatsApp} disabled={sending || selectedVoterIds.size === 0} className="w-full bg-brand-600 hover:bg-brand-700 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-brand-200 disabled:opacity-50 transition-all tutorial-wa-send">
