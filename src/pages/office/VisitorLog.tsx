                                                    ...
                                                    {filteredVisitors.map((v, index) => (
                                                        <tr key={v.id} className="hover:bg-slate-50">
                                                            ...
                                                            <td className="px-4 py-3 whitespace-nowrap">
                                                                <div className="text-sm font-bold text-slate-900"><TranslatedText text={v.name} /></div>
                                                            </td>
                                                            <td className="px-4 py-3 whitespace-nowrap text-sm text-slate-600">{v.mobile}</td>
                                                            <td className="px-4 py-3 whitespace-nowrap">
                                                                ...
                                                                {v.metadata?.amount && (
                                                                    <span className="ml-2 text-xs bg-emerald-50 text-emerald-700 px-1.5 py-0.5 rounded border border-emerald-100 font-medium">
                                                                        ₹{v.metadata.amount}
                                                                    </span>
                                                                )}
                                                            </td>
                                                            <td className="px-4 py-3 whitespace-nowrap">
                                                                {v.area && (
                                                                    <span className="text-sm text-slate-600 flex items-center gap-1.5">
                                                                        <MapPin className="w-3.5 h-3.5 text-slate-400" /> <TranslatedText text={v.area} />
                                                                    </span>
                                                                )}
                                                            </td>
                                                            <td className="px-4 py-3 whitespace-nowrap">
