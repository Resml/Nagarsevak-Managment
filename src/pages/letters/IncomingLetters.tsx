...
import { translateText, CUSTOM_TRANSLATIONS } from '../../services/translationService';
...
const IncomingLetters = () => {
    ...
    useEffect(() => {
        if (selectedIncoming?.scanned_file_url) {
            SecureStorageService.getUrl('documents', selectedIncoming.scanned_file_url)
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="sticky top-0 z-30 bg-slate-50 pt-1 pb-4 space-y-4">
                ...
                <div className="flex justify-end items-center border-b border-slate-200">
                                    ...
                                    <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/70">
                                        ...
                                        {selectedIncoming.file_type.includes('image') ? (
                                            previewUrl ? (
                                                ...
                                                <div className="flex items-center justify-center bg-white p-8 rounded-lg border border-slate-200 text-slate-400">
                                                    Loading preview...
                                                </div>
                                            )
                                        ) : (
