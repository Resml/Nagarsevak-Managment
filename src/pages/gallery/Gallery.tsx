...
const Gallery = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Grid */}
            {loading ? (
                <div className="text-center py-12 text-slate-500">{t('gallery.loading')}</div>
            ) : (
                        ...
                        <div key={item.id} className="ns-card overflow-hidden group">
                            ...
                            <div className="p-4">
                                <div className="flex justify-between items-start mb-2">
                                    <h3 className="font-semibold text-slate-900 line-clamp-1" title={item.title}>{item.title}</h3>
                                    <span className="text-xs text-slate-500 whitespace-nowrap">{item.date}</span>
                                </div>
                                {item.description && (
                                    <p className="text-sm text-slate-600 line-clamp-2" title={item.description}>
                                        {item.description}
                                    </p>
                                )}
                            </div>
